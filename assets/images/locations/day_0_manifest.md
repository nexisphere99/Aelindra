...
| `moonspire_bridge_ash_male.png` | day0_bridge scene banner (male Ash / default) | Same bridge, same chasm and dawn light. A half-elf bard (male presentation, soft features, silver rings) with honey-coloured eyes leans against the railing at the near end, lute notably absent for the first time, watching a dark-haired prince approach. |
