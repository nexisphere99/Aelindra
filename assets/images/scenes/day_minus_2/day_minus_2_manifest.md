...
`<<locationImage>>`, different folder and (as of this per-day reorganisation)
one subfolder per day, e.g. `assets/images/scenes/day_minus_2/`. Pass the
day folder as part of the slug: `<<sceneImage "day_minus_2/royal_gardens_ash_male" "...">>`.
This directory holds single-passage narrative-beat art (a specific story
moment, often character-specific or abstract) rather than reusable physical
places; see the top of `assets/images/locations/day_minus_2_manifest.md`
for the location/scene split rationale.
...
Selected via `<<set _gardensImg to ($bardGender is "female") ? "day_minus_2/royal_gardens_ash_female" : "day_minus_2/royal_gardens_ash_male">>`
